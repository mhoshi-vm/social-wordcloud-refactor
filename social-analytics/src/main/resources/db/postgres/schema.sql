...
(
    ...
    word_vector TEXT, -- In Postgres, you might eventually use the TSVECTOR type here
...
SELECT
    ...
    LEFT(gen_random_uuid()::TEXT, 8)              AS term,
...
(
    ...
    embedding  vector(1536), -- Postgres uses the [] syntax for arrays
